    ...
    <div class="container h-100">
        ...
        <div class="d-flex flex-column justify-content-between">
            <div class="d-flex justify-content-between">
                <div class="d-flex flex-column justify-content-between">
                    ...
                    <div class="form-group d-flex justify-content between">
                        ...
                        <input type="text" name="code_postal" id="code_postal" placeholder="Code postal" pattern="([0-9]{5})|([0-9][A|B][0-9]{3})" required>
                    </div>
                    <div class="form-group d-flex justify-content-between">
                ...
                <div class="d-flex flex-column justify-content-between">
                    ...
                    <div class="form-group d-flex justify-content-between">
                        ...
                        <input type="text" name="rue" placeholder="Rue" id="rue" required>
                    </div>
                    <div class="form-group d-flex justify-content-between">
            ...
            <div class="form-group d-flex justify-content-around">
                <button type="submit" class="btn btn-success" id="creer">Créer</button>
